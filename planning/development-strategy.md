...
- Developed on branches `searchHtml` and `searchCss`.
...
[ ] As a user, I want to be able to contact an admin of this web easily.
...
> There is an image for each post in Post page.
